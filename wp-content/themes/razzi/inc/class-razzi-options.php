	...
	public function customize_settings() {
		...
		$fields = array(
			...
			'search_columns'                   => array(
				'type'        => 'multicheck',
				'label'       => esc_html__( 'Search Columns', 'razzi' ),
				'section'     => 'header_search',
				'default'     => array( 'post_title', 'post_excerpt', 'post_content' ),
				'choices'     => array(
					'post_title'  => esc_html__( 'Title', 'razzi' ),
					'post_excerpt' => esc_html__( 'Excerpt', 'razzi' ),
					'post_content'   => esc_html__( 'Content', 'razzi' ),
				),
				'description' => esc_html__( 'Select which columns you want to search.', 'razzi' ),
				'active_callback'   => array(
					array(
			...
			'mobile_header_icons'               => array(
				...
				'mobile_product_tabs_status'           => array(
					...
					'choices' => array(
						...
						'all' 	=> esc_html__( 'Open all tab', 'razzi' ),
					),
				),
