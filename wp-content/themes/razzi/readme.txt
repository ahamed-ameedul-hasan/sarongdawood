...
- Fixed: Broken thumbnail styles in product gallery

Version 2.2.7

- New: Add a new option to hide product brand in the product page(https://prnt.sc/q26_ANd0m1V0)
- Updated: Disable Ecomus Product Brand when WooCommerce Product Brand is enabled
- Updated: Add a new option to sync the brand thumbnails(https://prnt.sc/Jw4MQmESdRuf)

Version 2.2.6

- Updated: Templates of WooCommerce 9.6.0
- Fixed: Sorting is not working on the product search results page

Version 2.2.5

- Fixed: Can't move items in the Element Carousel on mobile devices

Version 2.2.4

- Fixed: Compatible with Elementor 3.26.3

Version 2.2.3

- Updated: Templates of WooCommerce 9.5.1

Version 2.2.2

- Updated: Domain Path in the theme and Razzi Addons plugin
- Updated: Text Domain for Razzi Addons plugin

Version 2.2.0

- New: Added new option to change the blog navigation to Numeric
- New: Added new option to change the image ratio of Instagram Grid
- New: Added new option to open all product tabs on mobile
- New: Added a description option to Icon Box Carousel widget
- Updated: Templates of WooCommerce 9.4.1
- Updated: Templates of WCBoost Wishlist
- Fixed: Can't search products by SKU
- Fixed: Disable AJAX Add to Cart when Redirecting to Cart Page
- Fixed: Division by zero in the brands grid

Version 2.1.9

- Fixed: Can't load scripts of the theme

Version 2.1.8

- Updated: Compatible with WooCommerce 9.2.3
- Fixed: The arrows on subcategories are unresponsive
...
- Fixed: Encountering Issues with Numeric Attribute Filtering
- Fixed: Hide currencies when the visible option is not enabled

Version 2.1.5

- Updated: Compatible with WooCommerce 9.0.0
- Fixed: Can't click a button link on the slider

Version 2.1.4

- New: Add a new option to set search columns by the title, excerpt, content
- Updated: Compatible with WooCommerce 8.9.1
- Fixed: Change Twitter icon
- Fixed: Improve the speed to open the mini cart in the single product

Version 2.1.3

- Updated: The templates of WooCommerce 8.8.2
- Fixed: Thumbnail can't be changed when select a variation

Version 2.1.2

- Updated: The templates of WooCommerce 8.7
