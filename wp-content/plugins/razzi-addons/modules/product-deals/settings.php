...
class Settings {
	...
	public function add_deal_fields() {
        ...
        <p class="form-field _deal_quantity_field">
            <label for="_sale_quantity"><?php esc_html_e( 'Sale quantity', 'razzi-addons' ) ?></label>
			<?php echo wc_help_tip( __( 'Set this quantity will make the product to be a deal. The sale will end when this quantity is sold out.', 'razzi-addons' ) ); ?>
        ...
        <p class="form-field _deal_sales_counts_field">
            <label for="_sale_quantity"><?php esc_html_e( 'Sold Items', 'razzi-addons' ) ?></label>
			<?php echo wc_help_tip( __( 'Set this sold items should be less than the sale quantity.', 'razzi-addons' ) ); ?>
	...
	public function variation_settings_fields( $loop, $variation_data, $variation ) {
		woocommerce_wp_text_input(
			array(
				...
				'label'         => __( 'Sale quantity', 'razzi-addons' ),
				'desc_tip'      => true,
		...
		woocommerce_wp_text_input(
			array(
				...
				'label'         => __( 'Sold Items', 'razzi-addons' ),
				'desc_tip'      => true,
	...
	public function product_deals_section( $sections ) {
		$sections['rz_product_deals'] = esc_html__( 'Product Deals', 'razzi-addons' );
	...
	public function product_deals_settings( $settings, $section ) {
		if ( 'rz_product_deals' == $section ) {
			...
			$settings[] = array(
				...
				'title' => esc_html__( 'Product Deals', 'razzi-addons' ),
				'type'  => 'title',
			);
			...
			$settings[] = array(
				'id'      => 'rz_product_deals',
				'title'   => esc_html__( 'Product Deals', 'razzi-addons' ),
				'desc'    => esc_html__( 'Enable Product Deals', 'razzi-addons' ),
				'type'    => 'checkbox',
				'default' => 'yes',
			);
			...
			$settings[] = array(
				...
				'title'   => esc_html__( 'Expire Text', 'razzi-addons' ),
				'type'    => 'textarea',
				'default' => __( 'Hurry up!<br> Sales ends soon!', 'razzi-addons' ),
			);

			$settings[] = array(
				'id'      => 'rz_product_deals_sold_items_text',
				'title'   => esc_html__( 'Sold Items Text', 'razzi-addons' ),
				'type'    => 'text',
				'default' => esc_html__( 'Sold Items', 'razzi-addons' ),
			);

			$settings[] = array(
				'id'      => 'rz_product_deals_sold_text',
				'title'   => esc_html__( 'Sold Text', 'razzi-addons' ),
				'type'    => 'text',
				'default' => esc_html__( 'Sold', 'razzi-addons' ),
			);
