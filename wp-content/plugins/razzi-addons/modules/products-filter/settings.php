...
class Settings {
	...
	public function __construct() {
		...
		add_action( 'widgets_init', array( $this, 'register_widgets' ), 30 );
	...
	public function settings_api_init() {
		add_settings_section(
			...
			'<span id="product-filter-options">' . esc_html__( 'Products Filter', 'razzi-addons' ) . '</span>',
		...
		add_settings_field(
			$this->option,
			'<span class="product-filter-options">' . esc_html__( 'Products Filter', 'razzi-addons' ) . '</span>',
	...
	public function writing_section_html() {
		?>
        <p>
			<?php esc_html_e( 'Use these settings to disable product filter of widget on catalog page', 'razzi-addons' ); ?>
        </p>
		<?php
	}
	...
	public function disable_field_html() {
        ...
        <label for="<?php echo esc_attr( $this->option ); ?>">
			...
			<?php esc_html_e( 'Disable Product Filter for this site.', 'razzi-addons' ); ?>
        </label>
