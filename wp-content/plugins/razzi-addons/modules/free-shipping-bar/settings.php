...
class Settings  {
	...
	public function free_shipping_bar_section( $sections ) {
		$sections['rz_free_shipping_bar'] = esc_html__( 'Free Shipping Bar', 'razzi-addons' );
	...
	public function free_shipping_bar_settings( $settings, $section ) {
		if ( 'rz_free_shipping_bar' == $section ) {
			...
			$settings[] = array(
				...
				'title' => esc_html__( 'Free Shipping Bar', 'razzi-addons' ),
				'type'  => 'title',
			);
			...
			$settings[] = array(
				...
				'title'   => esc_html__( 'Free Shipping Bar', 'razzi-addons' ),
				'desc'    => esc_html__( 'Enable Free Shipping Bar', 'razzi-addons' ),
				'type'    => 'checkbox',
				'default' => 'no',
			);

			$settings[] = array(
				'desc'    => esc_html__( 'Checkout page', 'razzi-addons' ),
			...
			$settings[] = array(
				'desc'    => esc_html__( 'Product page', 'razzi-addons' ),
			...
			$settings[] = array(
				'desc'    => esc_html__( 'Cart page', 'razzi-addons' ),
