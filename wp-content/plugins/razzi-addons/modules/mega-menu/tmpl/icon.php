<div id="tamm-panel-icon" class="tamm-panel-icon tamm-panel">
	<div class="rz-tamm-panel-box-large mega-setting">
		<span class="setting-field rz-tamm-panel-select-field rz-tamm-panel-icon_type" data="{{data.megaData.icon_type}}">
			<label><?php esc_html_e( 'Icon Type', 'razzi-addons' ) ?></label>
			<select name="{{ taMegaMenu.getFieldName( 'icon_type', data.data['menu-item-db-id'] ) }}">
				<option value="none"><?php esc_html_e( 'None', 'razzi-addons' ) ?></option>
				<option value="svg" {{ 'svg' == data.megaData.icon_type ? 'selected="selected"' : '' }}><?php esc_html_e( 'SVG', 'razzi-addons' ) ?></option>
				<option value="image" {{ 'image' == data.megaData.icon_type ? 'selected="selected"' : '' }}><?php esc_html_e( 'Image', 'razzi-addons' ) ?></option>
			</select>
		</span>
		...
		<div class="setting-field setting-field-svg setting-field-select" style="{{ 'svg' == data.megaData.icon_type ? '' : 'display: none;' }}">
			<p class="tamm-icon-color">
				<label><?php esc_html_e( 'SVG Color', 'razzi-addons' ) ?></label><br>
		...
		<div class="setting-field setting-field-image" style="{{ 'image' == data.megaData.icon_type ? '' : 'display: none;' }}">
			<p class="background-image">
				<label><?php esc_html_e( 'Image', 'razzi-addons' ) ?></label><br>
				...
				<button type="button"
						class="button remove-button {{ ! data.megaData.icon_image ? 'hidden' : '' }}"><?php esc_html_e( 'Remove', 'razzi-addons' ) ?></button>
				<button type="button" class="button upload-button"
						id="imageSVG-button"><?php esc_html_e( 'Select Image', 'razzi-addons' ) ?></button>
