...
class Settings  {
	...
	public function variation_images_section( $sections ) {
		$sections['rz_variation_images'] = esc_html__( 'Variation Images Gallery', 'razzi-addons' );
	...
	public function variation_images_settings( $settings, $section ) {
		if ( 'rz_variation_images' == $section ) {
			...
			$settings[] = array(
				...
				'title' => esc_html__( 'Variation Images Gallery', 'razzi-addons' ),
				'type'  => 'title',
			);
			...
			$settings[] = array(
				...
				'title'   => esc_html__( 'Variation Images Gallery', 'razzi-addons' ),
				'desc'    => esc_html__( 'Enable Variation Images Gallery', 'razzi-addons' ),
				'type'    => 'checkbox',
				'default' => 'no',
			);
