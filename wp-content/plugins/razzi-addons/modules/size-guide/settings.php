...
class Settings  {
	...
	public function size_guide_section( $sections ) {
		$sections['razzi_addons_size_guide'] = esc_html__( 'Size Guide', 'razzi-addons' );
	...
	public function size_guide_settings( $settings, $section ) {
		...
		$settings_size_guide = array(
			array(
				'name' => esc_html__( 'Size Guide', 'razzi-addons' ),
				'type' => 'title',
				'id'   => self::OPTION_NAME . '_options',
			),
			array(
				'name'    => esc_html__( 'Enable Size Guide', 'razzi-addons' ),
				'desc'    => esc_html__( 'Enable product size guides', 'razzi-addons' ),
				'id'      => self::OPTION_NAME,
				'default' => 'no',
				'type'    => 'checkbox',
				'checkboxgroup' => 'start',
			...
			array(
				'desc'    => esc_html__( 'Enable on variable products only', 'razzi-addons' ),
			...
			array(
				'name'    => esc_html__( 'Guide Display', 'razzi-addons' ),
				'id'      => self::OPTION_NAME . '_display',
				'default' => 'tab',
				'class'   => 'wc-enhanced-select',
				'type'    => 'select',
				'options' => array(
					'tab'   => esc_html__( 'In product tabs', 'razzi-addons' ),
					'panel' => esc_html__( 'Panel by clicking on a button', 'razzi-addons' ),
					'popup' => esc_html__( 'Popup by clicking on a button', 'razzi-addons' ),
				),
			),
			array(
				'name'    => esc_html__( 'Button Position', 'razzi-addons' ),
				'id'      => self::OPTION_NAME . '_button_position',
				'default' => 'bellow_summary',
				'class'   => 'wc-enhanced-select',
				'type'    => 'select',
				'options' => array(
					'bellow_summary'   => esc_html__( 'Bellow short description', 'razzi-addons' ),
					'bellow_price'     => esc_html__( 'Bellow price', 'razzi-addons' ),
					'above_button'     => esc_html__( 'Above Add To Cart button', 'razzi-addons' ),
					'bellow_attribute' => esc_html__( 'Bellow the Size attribute (for variable products only)', 'razzi-addons' ),
				),
			),
			array(
				'name'    => esc_html__( 'Attribute Slug', 'razzi-addons' ),
				'id'      => self::OPTION_NAME . '_attribute',
				'default' => 'size',
				'type'    => 'text',
				'desc_tip' => esc_html__( 'This is the slug of a product attribute', 'razzi-addons' ),
			),
			array(
				'name'    => esc_html__( 'Button Text', 'razzi-addons' ),
				'id'      => self::OPTION_NAME . '_button_text',
				'default' => esc_html__('Size Chart', 'razzi-addons'),
				'type'    => 'text',
			),
			array(
				'type' => 'sectionend',
	...
	public function register_post_type() {
		...
		register_post_type( self::POST_TYPE, array(
			'description'         => esc_html__( 'Product size guide', 'razzi-addons' ),
			'labels'              => array(
				'name'                  => esc_html__( 'Size Guide', 'razzi-addons' ),
				'singular_name'         => esc_html__( 'Size Guide', 'razzi-addons' ),
				'menu_name'             => esc_html__( 'Size Guides', 'razzi-addons' ),
				'all_items'             => esc_html__( 'Size Guides', 'razzi-addons' ),
				'add_new'               => esc_html__( 'Add New', 'razzi-addons' ),
				'add_new_item'          => esc_html__( 'Add New Size Guide', 'razzi-addons' ),
				'edit_item'             => esc_html__( 'Edit Size Guide', 'razzi-addons' ),
				'new_item'              => esc_html__( 'New Size Guide', 'razzi-addons' ),
				'view_item'             => esc_html__( 'View Size Guide', 'razzi-addons' ),
				'search_items'          => esc_html__( 'Search size guides', 'razzi-addons' ),
				'not_found'             => esc_html__( 'No size guide found', 'razzi-addons' ),
				'not_found_in_trash'    => esc_html__( 'No size guide found in Trash', 'razzi-addons' ),
				'filter_items_list'     => esc_html__( 'Filter size guides list', 'razzi-addons' ),
				'items_list_navigation' => esc_html__( 'Size guides list navigation', 'razzi-addons' ),
				'items_list'            => esc_html__( 'Size guides list', 'razzi-addons' ),
			),
	...
	public function edit_admin_columns( $columns ) {
		$columns = array_merge( $columns, array(
			'apply_to' => esc_html__( 'Apply to Category', 'razzi-addons' )
		) );
	...
	public function manage_custom_columns( $column, $post_id ) {
		switch ( $column ) {
			case 'apply_to':
				...
				switch ( $selected ) {
					case 'none':
						esc_html_e( 'No Category', 'razzi-addons' );
						break;

					case 'all':
						esc_html_e( 'All Categories', 'razzi-addons' );
						break;
					...
					case 'custom':
						...
						if ( is_array( $cats ) ) {
							...
							$links[] = esc_html_e( 'No Category', 'razzi-addons' );
						}
	...
	public function meta_boxes( $post ) {
		add_meta_box( 'razzi-size-guide-category', esc_html__( 'Apply to Categories', 'razzi-addons' ), array( $this, 'category_meta_box' ), self::POST_TYPE, 'side' );
		add_meta_box( 'razzi-size-guide-tables', esc_html__( 'Tables', 'razzi-addons' ), array( $this, 'tables_meta_box' ), self::POST_TYPE, 'advanced', 'high' );
	}
	...
	public function category_meta_box( $post ) {
		...
		<p>
			<label>
				...
				<?php esc_html_e( 'No category', 'razzi-addons' ); ?>
			</label>
		</p>
		...
		<p>
			<label>
				...
				<?php esc_html_e( 'All Categories', 'razzi-addons' ); ?>
			</label>
		</p>
		...
		<p>
			<label>
				...
				<?php esc_html_e( 'Select Categories', 'razzi-addons' ); ?>
			</label>
		</p>
	...
	public function tables_meta_box( $post ) {
		...
		$tables = $tables ? $tables : array(
			'names' => array( '' ),
			'tabs' => array( __( 'Table 1', 'razzi-addons' ) ),
			'tables' => array( '[["",""],["",""]]' ),
			'descriptions' => array( '' ),
			'information' => array( '' ),
		);
		...
		<div id="razzi-size-guide-tabs" class="razzi-size-guide-tabs">
			<div class="razzi-size-guide-tabs--tabs">
				<div class="razzi-size-guide-table-tabs--tab add-new-tab" data-title="<?php esc_attr_e( 'Table', 'razzi-addons' ) ?>"><span class="dashicons dashicons-plus"></span></div>
			</div>
		</div>
	...
	public function templates() {
		...
		<script type="text/html" id="tmpl-razzi-size-guide-panel">
			<div class="razzi-size-guide-table-editor" data-tab="{{data.index}}">
				<p>
					<label>
						<?php esc_html_e( 'Table Name', 'razzi-addons' ); ?><br/>
	...
	public function product_data_tab( $tabs ) {
		$tabs['razzi_size_guide'] = array(
			'label'    => esc_html__( 'Size Guide', 'razzi-addons' ),
	...
	public function product_data_panel() {
		...
		$button_options = array(
			...
			'bellow_price'     => esc_html__( 'Bellow price', 'razzi-addons' ),
			'above_button'     => esc_html__( 'Above Add To Cart button', 'razzi-addons' ),
			'bellow_attribute' => esc_html__( 'Bellow the Size attribute', 'razzi-addons' ),
		);
		...
		$guide_options = array(
			...
			'none' => esc_html__( '--No Size Guide--', 'razzi-addons' ),
		);
		...
		<div id="razzi-size-guide" class="panel woocommerce_options_panel hidden" data-nonce="<?php echo esc_attr( wp_create_nonce( 'razzi_size_guide' ) ) ?>">
			...
			<div class="options_group">
				...
				woocommerce_wp_select( array(
					...
					'label'   => esc_html__( 'Size Guide Display', 'razzi-addons' ),
					'options' => array_merge( array( '' => esc_html__( 'Default', 'razzi-addons' ) . ' (' . $display_options[ $default_display ] . ')' ), $display_options ),
				) );
				...
				woocommerce_wp_select( array(
					...
					'label'   => esc_html__( 'Button Position', 'razzi-addons' ),
					'options' => array_merge( array( '' => esc_html__( 'Default', 'razzi-addons' ) . ' (' . $button_options[ $default_positon ] . ')' ), $button_options ),
				) );
				...
				if ( ! empty( $attribute_options ) ) {
					woocommerce_wp_select( array(
						...
						'label'   => esc_html__( 'Attribute', 'razzi-addons' ),
