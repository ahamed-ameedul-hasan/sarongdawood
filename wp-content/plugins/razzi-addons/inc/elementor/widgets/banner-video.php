...
class Banner_Video extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Razzi - Banner Video', 'razzi-addons' );
	}
	...
	protected function section_content() {
		...
		$this->add_control(
			'video_type',
			[
				'label' => __( 'Source', 'razzi-addons' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'youtube',
				'options' => [
					'youtube' => __( 'YouTube', 'razzi-addons' ),
					'vimeo' => __( 'Vimeo', 'razzi-addons' ),
					'self_hosted' => __( 'Self Hosted', 'razzi-addons' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Enter your URL', 'razzi-addons' ) . ' (YouTube)',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Link', 'razzi-addons' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'Enter your URL', 'razzi-addons' ) . ' (Vimeo)',
		...
		$this->add_control(
			'insert_url',
			[
				'label' => __( 'External URL', 'razzi-addons' ),
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Enter your URL', 'razzi-addons' ),
				'autocomplete' => false,
				'options' => false,
				'label_block' => true,
				'show_label' => false,
		...
		$this->add_control(
			'hosted_url',
			[
				'label' => __( 'Choose File', 'razzi-addons' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => __( 'Background', 'razzi-addons' ),
		...
		$this->add_control(
			...
			[
				...
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'only'   => esc_html__( 'Only marker', 'razzi-addons' ),
	...
	protected function section_style() {
		...
		$this->add_responsive_control(
			'icon_size',
			[
				'label'     => __( 'Font Size', 'razzi-addons' ),
				'type'      => Controls_Manager::SLIDER,
				'default'   => [],
				'range'     => [
					'px' => [
