...
class WeDesignTech_Widget_Base_Advanced_Video {
    ...
    public function create_elementor_controls($elementor_object) {
		...
		$elementor_object->add_control( 
			'enable_autoplay', 
			array(
				'label' => esc_html__( 'Enable Autoplay', 'wdt-elementor-addon' ),
            ...
            $output .=  '<div class="wdt-advanced-video-container">';
				$output .= '<div class="wdt-advanced-video">';
				 	...
				 	if($settings['enable_autoplay'] == 'yes'){
						$output .= '<div class="wdt-play-button"><span class="wdt-control-icons"><i class="fa fa-solid fa-pause"></i></span></div>';
						$output .= '<video autoplay loop muted class="advanced-video" src="'.esc_attr( $video_url ).'"></video>';
					} else{
						$output .= '<div class="wdt-play-button"><span class="wdt-control-icons"><i class="fa fa-solid fa-play"></i></span></div>';
						$output .= '<video loop muted class="advanced-video" src="'.esc_attr( $video_url ).'"></video>';
					}
