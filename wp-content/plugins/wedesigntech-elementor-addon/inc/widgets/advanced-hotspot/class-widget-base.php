...
class WeDesignTech_Widget_Base_Advanced_Hotspot {
	...
	public function name() {
		return 'wdt-advanced-hotspot';
	}

	public function title() {
		return esc_html__( 'Advanced Hotspot', 'wdt-elementor-addon' );
	}
	...
	public function init_styles() {
		return array (
				$this->name() =>  WEDESIGNTECH_ELEMENTOR_ADDON_DIR_URL.'inc/widgets/advanced-hotspot/assets/css/style.css'
			);
	}
	...
	public function init_scripts() {
		return array (
			$this->name() =>  WEDESIGNTECH_ELEMENTOR_ADDON_DIR_URL.'inc/widgets/advanced-hotspot/assets/js/script.js'
		);
	}
			...
			$elementor_object->add_control(
				...
				array (
					...
					'options' => array (
						...
						'wdt-advanced-hotspot-soft-beat' => esc_html__( 'Soft Beat', 'wdt-elementor-addon' ),
						'wdt-advanced-hotspot-expand' => esc_html__( 'Expand', 'wdt-elementor-addon' ),
						'wdt-advanced-hotspot-overlay' => esc_html__( 'Overlay', 'wdt-elementor-addon' ),
						'wdt-advanced-hotspot-ripple' => esc_html__( 'Ripple', 'wdt-elementor-addon' )
					),
					'default' => '',
					'separator' => 'after'
				)
		...
		$this->cc_style->get_style_controls($elementor_object, array (
			...
			'styles' => array (
				'font_size' => array (
					...
					'selector' => array (
						'{{WRAPPER}} .wdt-advanced-hotspot-item-trigger .wdt-advanced-hotspot-item-default, {{WRAPPER}} .wdt-advanced-hotspot-item-trigger .wdt-advanced-hotspot-item-number, {{WRAPPER}} .wdt-advanced-hotspot-item-trigger .wdt-advanced-hotspot-item-alphabet, {{WRAPPER}} .wdt-advanced-hotspot-item-trigger .wdt-advanced-hotspot-item-icon .wdt-content-icon-wrapper .wdt-content-icon span' => 'font-size: {{SIZE}}{{UNIT}};'
					),
					'condition' => array ()
				),
				'margin' => array (
						...
						'hover' => array (
							...
							'styles' => array (
								'color' => array (
									'field_type' => 'color',
									'selector' => array (
										'{{WRAPPER}} .wdt-advanced-hotspot-item-trigger:hover .wdt-advanced-hotspot-item-default, {{WRAPPER}} .wdt-advanced-hotspot-item-trigger .wdt-advanced-hotspot-item-number, {{WRAPPER}} .wdt-advanced-hotspot-item-trigger .wdt-advanced-hotspot-item-alphabet, {{WRAPPER}} .wdt-advanced-hotspot-item-trigger:hover .wdt-advanced-hotspot-item-icon .wdt-content-icon-wrapper .wdt-content-icon span' => 'color: {{VALUE}};'
									),
									'condition' => array ()
								),
							)
		...
		$this->cc_style->get_style_controls($elementor_object, array (
			...
			'styles' => array (
				'typography' => array (
					...
					'selector' => '{{WRAPPER}} .wdt-advanced-hotspot-item-trigger .wdt-advanced-hotspot-item-label',
					'condition' => array ()
				),
				'tabs' => array (
					'field_type' => 'tabs',
						...
						'normal' => array (
							...
							'styles' => array (
								'color' => array (
									'field_type' => 'color',
									'selector' => array (
										'{{WRAPPER}} .wdt-advanced-hotspot-item-trigger .wdt-advanced-hotspot-item-label' => 'color: {{VALUE}};'
									),
									'condition' => array ()
								),
							)
						...
						'hover' => array (
							...
							'styles' => array (
								'color' => array (
									'field_type' => 'color',
									'selector' => array (
										'{{WRAPPER}} .wdt-advanced-hotspot-item-trigger:hover .wdt-advanced-hotspot-item-label' => 'color: {{VALUE}};'
									),
									'condition' => array ()
								),
							)
		...
		$this->cc_style->get_style_controls($elementor_object, array (
			...
			'styles' => array (
				'margin' => array (
					'field_type' => 'margin',
					'selector' => array (
                        '{{WRAPPER}} .wdt-advanced-hotspot-item-trigger' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ),
					'condition' => array ()
				),
				'padding' => array (
					'field_type' => 'padding',
					'selector' => array (
						'{{WRAPPER}} .wdt-advanced-hotspot-item-trigger' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					),
					'condition' => array ()
				),
				'tabs' => array (
						...
						'normal' => array (
							...
							'styles' => array (
								'color' => array (
									'field_type' => 'color',
									'selector' => array (
										'{{WRAPPER}} .wdt-advanced-hotspot-item-trigger' => 'color: {{VALUE}};'
									),
									'condition' => array ()
								),
								'background' => array (
									'field_type' => 'background',
									'selector' => '{{WRAPPER}} .wdt-advanced-hotspot-item-trigger',
									'condition' => array ()
								),
								'border' => array (
									'field_type' => 'border',
								...
								'border_radius' => array (
									...
									'selector' => array (
										'{{WRAPPER}} .wdt-advanced-hotspot-item-trigger' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
									),
									'condition' => array ()
								),
								'box_shadow' => array (
						...
						'hover' => array (
							...
							'styles' => array (
								'color' => array (
									'field_type' => 'color',
									'selector' => array (
										'{{WRAPPER}} .wdt-advanced-hotspot-item-trigger:hover' => 'color: {{VALUE}};'
									),
									'condition' => array ()
								),
								'background' => array (
									'field_type' => 'background',
									'selector' => '{{WRAPPER}} .wdt-advanced-hotspot-item-trigger:hover',
									'condition' => array ()
								),
								'border' => array (
									'field_type' => 'border',
								...
								'border_radius' => array (
									'field_type' => 'border_radius',
									'selector' => array (
										'{{WRAPPER}} .wdt-advanced-hotspot-item-trigger:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
									),
									'condition' => array ()
								),
								'box_shadow' => array (
	...
	public function render_html($widget_object, $settings) {
		...
		$output .= '<div class="wdt-advanced-hotspot-holder" data-settings="'.esc_js($json_settings).'">';
			...
			if( is_array($settings['hotspots']) && !empty($settings['hotspots']) ) {
				$output .= '<div class="wdt-advanced-hotspot-items-holder">';
					foreach ( $settings['hotspots'] as $key => $hotspot ) {
						...
						if( $hotspot['content_type'] == 'template' ) {
							...
							if($hotspot['show_tooltip_content'] && $hotspot['tooltip_content']) {
								...
								if(isset($hotspot['tooltip_image']['url']) && !empty($hotspot['tooltip_image']['url'])) {
									$media_image_setting = array ();
									$media_image_setting['image'] = $settings['tooltip_image'];
									$media_image_setting['image_size'] = 'thumbnail';
									$hostspot_image .= '<span class="wdt-advanced-hotspot-image">';
										$hostspot_image .= $this->render_tooltip_image($hotspot, '', '');
									$hostspot_image .= '</span>';
								}
	
								if( !empty($hotspot['tooltip_content']) && !empty($hotspot['tooltip_label']) ) {
									$tooltip_content .= '<div class="wdt-advanced-hotspot-content">';
								}
						...
						$hotspot_repeater_setting_key = 'wdt-advanced-hotspot-repeater-item-'.$key;
						$widget_object->add_render_attribute(
							$hotspot_repeater_setting_key, array (
								'class' => array (
									'wdt-advanced-hotspot-repeater-item',
									'elementor-repeater-item-' . $hotspot['_id'],
									$is_hotspot_link ? 'wdt-advanced-hotspot-link' : ''
								),
						...
						$hotspot_repeater_trigger_setting_key = 'wdt-advanced-hotspot-repeater-trigger-item-'.$key;
						$widget_object->add_render_attribute(
						...
						$output .= '<div class="wdt-advanced-tooltip-wrapper">';

							$output .= '<div class="wdt-advanced-tooltip-content">';
								...
								$output .= '<div '.$widget_object->get_render_attribute_string( $hotspot_repeater_trigger_setting_key ).'>';
									...
									if($settings['hotspot_type'] == 'icon') {
										if($hotspot['media_icon']['value']) {
											...
											$output .= '<div class="wdt-advanced-hotspot-item-icon">';
												$output .= $this->cc_repeater_contents->render_icon($key, $icon_item, $widget_object);
											$output .= '</div>';
										} else {
											$output .= '<div class="wdt-advanced-hotspot-item-default">';
												$output .= '<i class="fas fa-plus"></i>';
											$output .= '</div>';
										}
									} elseif($settings['hotspot_type'] == 'alphabet') {
										$alphabets = range('A', 'Z');
										$output .= '<div class="wdt-advanced-hotspot-item-alphabet">';
											$output .= $alphabets[$key];
										$output .= '</div>';
									} else if($settings['hotspot_type'] == 'number') {
										$output .= '<div class="wdt-advanced-hotspot-item-number">';
											$output .= $key+1;
										$output .= '</div>';
									} else {
										$output .= '<div class="wdt-advanced-hotspot-item-default">';
									...
									if($hotspot['show_label'] && !empty($hotspot['label'])) {
										$output .= '<div class="wdt-advanced-hotspot-item-label">'.esc_html($hotspot['label']).'</div>';
									}
								$output .= '</div>';
								/* if($hotspot['show_tooltip_content']) {
									$output .= '<div class="wdt-advanced-hotspot-item-tooltip">'.esc_html($hotspot['tooltip_content']).'</div>';
								} */
...
if( !function_exists( 'wedesigntech_widget_base_advanced_hotspot' ) ) {
    function wedesigntech_widget_base_advanced_hotspot() {
        return WeDesignTech_Widget_Base_Advanced_Hotspot::instance();
    }
}