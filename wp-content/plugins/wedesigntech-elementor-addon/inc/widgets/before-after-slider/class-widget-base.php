        ...
        $output = '';
            $output .=  ' <div class="wdt-before-after-slider-container"> ';
                ...
                if($settings['first-image']['url'] != '') {
                    ...
                    $output .= '<span class="wdt-before-after-slider-span-after">'.esc_html__('After Khadija Products', 'wdt-elementor-addon').'</span>';
                }
                $output .=  ' </div>';
                ...
                if($settings['second-image']['url'] != '') {
                    ...
                    $output .= '<span class="wdt-before-after-slider-span-before">'.esc_html__('Before Khadija Products', 'wdt-elementor-addon').'</span>';
                }
                $output .=  ' </div>';
